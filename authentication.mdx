...
description: "How to authenticate against the LoyaltyDog API with bearer tokens and API keys."
---
...
| **API key** | Third-party apps acting on behalf of a merchant | `POST /v2/appkeys` (see the [API reference](/api-reference)) |
...
<CardGroup cols={2}>
  ...
  <Card title="Compatibility" icon="code-compare" href="/compatibility">
    What changes (and what doesn't) with a hashed public key.
  </Card>
  <Card title="Rate limits" icon="gauge" href="/rate-limits">
    Burst, sustained, and monthly limits.
  </Card>
</CardGroup>
