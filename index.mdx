...
The LoyaltyDog API uses bearer-token authentication. To request a key for your merchant account, [contact us](https://loyalty.dog/). Once provisioned, you can manage API keys via [`POST /v2/appkeys`](/api-reference).
