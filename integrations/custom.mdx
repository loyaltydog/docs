...
- **Scope tokens per integration.** Use a dedicated API key for each integration so you can rotate or revoke without impacting other systems.
...
<CardGroup cols={2}>
  ...
  <Card title="Authentication" icon="key" href="/authentication">
    Bearer tokens, API keys, and rotation.
  </Card>
