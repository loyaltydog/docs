...
The LoyaltyDog API uses bearer-token authentication. Create a dashboard [App Key](https://app.loyalty.dog/account/appkeys) (JWT). `POST /appkeys` is dashboard-only and still mints JWTs — there is no public hashed-key issuance API.
